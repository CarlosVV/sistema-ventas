...
namespace LuzDelSur.Administrativo.Liven.Emidoc.Svc.DataAccess {
    public class DOOrigenes {
        ...
        public DOOrigenes(InformixHelper informixHelper) {
        ...
        public List<BEDocumento> ObtenerOrigenes(BEDocumentoConsultaRequest objDocumentoEntidadRequest) {
