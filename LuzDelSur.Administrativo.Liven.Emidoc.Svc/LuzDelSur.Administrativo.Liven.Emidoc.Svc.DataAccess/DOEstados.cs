...
namespace LuzDelSur.Administrativo.Liven.Emidoc.Svc.DataAccess {
    public class DOEstados {
        ...
        public DOEstados(InformixHelper informixHelper) {
        ...
        public List<BEDocumento> ObtenerEstados(BEDocumentoConsultaRequest objDocumentoEntidadRequest) {
