...
namespace LuzDelSur.Administrativo.Liven.Emidoc.Svc.DataAccess {
    public class DODocumentos {
        ...
        public DODocumentos(InformixHelper informixHelper) {
        ...
        public List<BEDocumento> BuscarDocumentos(BEDocumentoConsultaRequest objDocumentoEntidadRequest) {
