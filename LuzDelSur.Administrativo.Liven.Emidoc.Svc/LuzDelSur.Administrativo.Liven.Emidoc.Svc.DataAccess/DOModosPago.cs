...
namespace LuzDelSur.Administrativo.Liven.Emidoc.Svc.DataAccess {
    public class DOModosPago {
        ...
        public DOModosPago(InformixHelper informixHelper) {
        ...
        public List<BEDocumento> ObtenerModosPago(BEDocumentoConsultaRequest objDocumentoEntidadRequest) {
