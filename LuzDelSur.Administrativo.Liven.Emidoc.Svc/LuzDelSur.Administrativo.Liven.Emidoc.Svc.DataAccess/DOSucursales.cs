...
namespace LuzDelSur.Administrativo.Liven.Emidoc.Svc.DataAccess {
    public class DOSucursales {
        ...
        public DOSucursales(InformixHelper informixHelper) {
        ...
        public List<BEDocumento> ObtenerSucursales(BEDocumentoConsultaRequest objDocumentoEntidadRequest) {
